...
-- only add or remove things from the top.
-- LIFO (Last In First Out): the last number PUSHED on the stack will be
-- the first number POPed off the stack.
-----------------------------------------------------------------------
-- CONSTRUCTOR FUNCTION   int_stack( self IN OUT int_stack )   RETURN self AS RESULT
-- The constructor function, here it is named int_stack(), is like the 
--   'new' method in Java
-- The constructor function can be named anything
-----------------------------------------------------------------------
